--my csv file is called imported_pokemon_Data_old
--im putting the data of that into the table called imported_pokemon_Data
...
SELECT * FROM imported_pokemon_Data_old;
